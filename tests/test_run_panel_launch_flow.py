...
from arena_forge.adapters.sublime.run_panel.launch_flow import plan_run_panel_launch
...
class RunPanelLaunchFlowTests(unittest.TestCase):
    def test_plan_ignores_launch_while_compiling(self) -> None:
        plan = plan_run_panel_launch(
            ...
            request=RunPanelActionRequest(run_file="main.cpp"),
            saved_session=None,
        )
    ...
    def test_plan_requests_rerun_when_process_is_running(self) -> None:
        request = RunPanelActionRequest(run_file="main.cpp", use_debugger=True, load_session=True)
    ...
    def test_plan_restores_saved_session_when_requested(self) -> None:
        ...
        plan = plan_run_panel_launch(
            status_code="STOPPED",
            request=RunPanelActionRequest(load_session=True),
