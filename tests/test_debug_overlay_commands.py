...
def _patched_sublime(callbacks):
    ...
    original_messages = sys.modules.get("arena_forge.adapters.sublime.messages")
    original_package_resources = sys.modules.get("arena_forge.adapters.sublime.package_resources")
    ...
    sys.modules["arena_forge.adapters.sublime.package_resources"] = types.SimpleNamespace(
    ...
    sys.modules.pop("arena_forge.adapters.sublime.debug_overlay_commands", None)
    try:
        yield
    finally:
        sys.modules.pop("arena_forge.adapters.sublime.debug_overlay_commands", None)
        ...
        if original_messages is None:
            ...
            sys.modules["arena_forge.adapters.sublime.messages"] = original_messages
        if original_package_resources is None:
            sys.modules.pop("arena_forge.adapters.sublime.package_resources", None)
        else:
            sys.modules["arena_forge.adapters.sublime.package_resources"] = original_package_resources
...
class DebugOverlayCommandsTests(unittest.TestCase):
    def test_schedule_sidebar_hide_only_uses_supported_window_api(self) -> None:
        ...
        with _patched_sublime(callbacks):
            module = importlib.import_module("arena_forge.adapters.sublime.debug_overlay_commands")
            calls = []
